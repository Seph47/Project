package br.com.osf.bikestoreproject.controller;
...
import br.com.osf.bikestoreproject.exception.ResourceNotFoundException;
import br.com.osf.bikestoreproject.repository.CustomerRepository;
...
public class CustomerController {
	...
	@PutMapping("/{id}")
	public Customer updateCustomer(@RequestBody Customer customer, @PathVariable (value = "id") long customerId) {
		String message = "Sorry, no customer with id "+customerId+" was found.";
